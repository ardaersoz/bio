    ...
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 text-center">
          ...
          <h2 className="text-4xl font-bold text-gray-900 py-5 text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-x-5 gap-y-8 md:gap-x-8 lg:flex-nowrap lg:justify-between">
          {/* Feature 1 */}
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            <div className="bg-indigo-50 rounded-lg flex justify-center items-center mb-5 w-20 h-20 mx-auto cursor-pointer transition-all duration-500 group-hover:bg-indigo-600">
              <svg
                className="stroke-indigo-600 transition-all duration-500 group-hover:stroke-white w-6 h-6" // Added width and height
                viewBox="0 0 30 30"
                fill="none"
              ...
              >
                <path
                  ...
                  stroke="currentColor" // Added stroke property
                  strokeWidth="2"
                  strokeLinecap="round"
          ...
          {/* ... other features similarly structured ... */}
        </div>
      </div>
    </section>
  );
